...
class CoursesListPage(BasePage):
    def __init__(self, page: Page):
        ...
        self.course_min_text = page.get_by_test_id('course-min-score-info-view-text')
    ...
    def check_visible_course_card(self,                   #index - для проверки нескольких элементов с одинаковым data-test-id на странице
        ...
        expect(self.course_menu_button.nth(index)).to_have_visible(f'Estimated time: {estimated_time}')
